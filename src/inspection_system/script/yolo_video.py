...
i_vid = r'videos\Video1.mp4'
# o_vid = r'videos\car_chase_01_out.mp4'
y_path = r'config'
sg.theme('light green')

layout = 	[
		[sg.Text('Video Player', size=(18,1), font=('Any',18),text_color='#1c86ee' ,justification='left')],
		...
		[sg.Text('base path'), sg.In(y_path,size=(40,1), key='config'), sg.FolderBrowse()],
...
labelsPath = os.path.sep.join([args["config"], "obj.names"])
...
weightsPath = os.path.sep.join([args["config"], "model0416.weights"])
configPath = os.path.sep.join([args["config"], "model0416.cfg"])
